...
<div class="HistoryDeptIn">
    ...
    <!-- Main table element -->
    <b-table show-empty small stacked="md" :items="items" :fields="fields" :current-page="currentPage3" :per-page="perPage3" :filter="filter" :filterIncludedFields="filterOn" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" :sort-direction="sortDirection" @filtered="onFiltered">
        ...
        <template v-slot:cell(actionsion)="row">
            ...
            <b-button size="sm" @click="hamxoa(row.item, row.index, $event.target)" class="mr-1">
    ...
    <b-modal :id="infoModal.id" :title="infoModal.title" ok-only @hide="resetInfoModal">
        <b-form-group label-cols-sm="12" label-cols-md="4" label="Tên" label-for="mnemonicName">
            <b-form-input v-model="infoModal.content.Name">
            </b-form-input>
        </b-form-group>
        ...
        <b-form-group label-cols-sm="12" label-cols-md="4" label="Email" label-for="mnemonicName">
            <b-form-input v-model="infoModal.content.Email">
            </b-form-input>
        </b-form-group>
...
export default {
    ...
    methods: {
        ...
        info(item, index, button) {
            this.infoModal.title = "Xóa tài khoản";
