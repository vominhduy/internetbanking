<template>
  <div style="margin-top:70px; padding: 10px;">
    <b-form @submit.prevent="login($event)" @reset="onReset" v-if="show">
      ...
      <b-form-group>
        <b-link to="/password/forget">Quên mật khẩu?</b-link>
      </b-form-group>
      <b-button type="submit" variant="primary">Đăng nhập</b-button>
      <b-button type="reset" variant="danger" style="margin-left: 10px;">Tải lại</b-button>
    </b-form>
  </div>
</template>
